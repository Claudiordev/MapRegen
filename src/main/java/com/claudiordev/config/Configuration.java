...
public class Configuration {
    ...
    static List<String> helpMessage,worldGuardRegions,blockExceptions;
    ...
    public static void load() {
        ...
        blockExceptions = getPlugin().getConfig().getStringList("Block_exceptions");
    }
    ...
    public static List<String> getBlockExceptions() {
